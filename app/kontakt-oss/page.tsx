...
export const metadata: Metadata = {
  ...
  description: 'Ta kontakt for brannprosjektering og brannkonsept. Vi svarer innen 24 timer. Gratis og uforpliktende tilbud.',
            ...
            <ScrollReveal delay={100} className="lg:col-span-2">
              <div className="bg-brand-dark rounded-[30px] p-8 text-brand-white h-full">
                ...
                <div className="space-y-6">
                  {[
                    { Icon: Phone, label: 'Telefon', value: '+47 973 49 273', href: 'tel:+4797349273' },
